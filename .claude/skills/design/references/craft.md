...
Run /design shape, passing along whatever feature description the user provided.
...
If the user has already run /design shape and has a confirmed design brief, skip this step and use the existing brief.
