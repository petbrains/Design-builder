...
Systematic guide for reviewing motion design in web UI code. Use alongside [`motion-gaps.md`](motion-gaps.md) (run that FIRST to find missing animations) and [`common-mistakes.md`](common-mistakes.md).
...
See [`accessibility.md`](accessibility.md) for deep dive.
