...
Jakub Krehel is a design engineer known for his work at [jakub.kr](https://jakub.kr). His approach emphasizes **subtle production polish** — animations that enhance the experience invisibly, designed for real client work where users will interact repeatedly.
